...
void main() {
  ...
  debugPrint('  Email field: ${DataGenerator.getDataForInputType('email', 'email')}');
  debugPrint('  Phone field: ${DataGenerator.getDataForInputType('tel', 'phone')}');
  debugPrint('  Name field: ${DataGenerator.getDataForInputType('text', 'name')}');
  debugPrint('  Age field: ${DataGenerator.getDataForInputType('number', 'age')}');
  debugPrint('  Website field: ${DataGenerator.getDataForInputType('url', 'website')}');
